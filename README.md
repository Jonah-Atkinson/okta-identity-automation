...
## Scripts
### list_users.py
Lists every user's login and status.
...
| 8 | Activation already pending (idempotent) | Same user as #6 again with `--confirm` | `Bob Smith has a pending activation.`                                                                                                    | 0 |
| 9 | Already active | ACTIVE user with `--confirm` | `Jane Dane is already activated.`                                                                                                        | 0 |
| 10 | Password expired | User with an admin-set temporary password, with and without `--confirm` | `Bob Smith has an expired password.`                                                                                                     | 0 |
...
### deactivate_user.py: Deactivates user, can be reactivated.
  ...
  - Passed 9 different checks as listed below:
